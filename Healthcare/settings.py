...
from app.custom_hash import CustomHash
...
SECRET_KEY = 'django-insecure-kssc(=2cl%=1vg=03#r$^jo-t&j4ht258dm-l+5joqlfj@tcog'
...
AUTHENTICATION_BACKENDS = [
    'app.backends.RoleBasedAuthBackend',  # Custom backend
